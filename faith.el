;;; faith.el --- helps spreading the true faith
;; Time-stamp: <2007-12-06 11:25:01 deego>
...
(defconst faith-version "2.0dev"
  "Version number of faith.el")

;; This file is not (yet) part of GNU Emacs.

;; WEBSITE: http://gnufans.net/~deego/emacspub/faith/
...
;;; Drop faith.el somewhere in yourr load-path, and add to your
;;; .emacs: (load "faith.el") then type M-x faith, and enjoy..
...
Argument QUOTES is a list of quotes."
  (let* ((n (random* (length quotes)))
	 (s (nth n quotes)))
    (if (stringp s) s
      (error "The quote at postition %d is no string." n s))))
...
(unless faith-replacement-strings
  (setq faith-replacement-strings
	'(
	  ...
	  (("the calf") ("vi"))
	  (("the\ncalf") ("vi"))
	  ;; sometimes the calf may get missed... so let's have a calf now.
	  (("calf") ("vi"))

	  ;; retain prophet
	  (("prophet") ("project leader"))
	  (("religion") ("editing"))
	  (("satan") ("Microsoft" "Windoze" "SCO" "VI" "Bill Gates"))
	  (("prayer" ) ("edit"))
	  (("pray" ) ("edit"))
	  (("synagogue" "church" "synagog") ("computer room"))
	  )))
...
shall have none to guide him."
   ...
   ;; 2004-02-20 T13:19:20-0500 (Friday)    D. Goel
   ;; add quotes from a posting by Oliver Shultz
   "23:1 Emacs is my editor; I shall not want."

   "23:2 It maketh me to indent my code correctly: It leadeth me
beside every functionality conceivable."

   "23:3 It restoreth my files: It leadeth me in the paths of executables
for its name's sake."
...
comfort me."
   ...
   "23:5 Thou preparest a buffer before me in the presence of mine shell:
thou anointest my code with font-lock; my $HOME runneth over."


   
   "23:6 Surely goodness and mercy shall follow me all the days of my
life: and I will dwell in the frames of Emacs for ever."
